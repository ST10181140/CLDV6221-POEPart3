...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p>
            Choose a table to display<asp:DropDownList ID="displayChoice" runat="server" AutoPostBack="True" OnSelectedIndexChanged="choiceDropDown_SelectedIndexChanged">
            ...
            <br />
            <br />
            Choose a table to alter<asp:DropDownList ID="deleteChoice" runat="server" AutoPostBack="True">
                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
