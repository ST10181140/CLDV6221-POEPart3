...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID ="labelHeading" runat ="server" Text ="Read Page" Font-Bold ="True" Font-Italic ="False" Font-Size ="18pt" Font-Underline="False" ForeColor="#0066FF"></asp:Label>
            <br />
            
            <asp:Label ID ="labelSelection" runat ="server" Text ="Select a table to read: "></asp:Label>
             <asp:DropDownList ID="ReadChoice" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ReadChoice_SelectedIndexChanged" BackColor="#CCFFFF">
            ...
            <asp:GridView ID="GridViewFine" runat="server" AutoGenerateColumns="False" DataKeyNames="FineID" DataSourceID="SqlDataSourceFine" BackColor="#66CCFF">
                <Columns>
            ...
            <asp:GridView ID="GridViewRental" runat="server" AutoGenerateColumns="False" DataKeyNames="CarNo,InspectorNo,DriverID" DataSourceID="SqlDataSourceRental" BackColor="#66CCFF">
                <Columns>
                    <asp:BoundField DataField="CarNo" HeaderText="CarNo" ReadOnly="True" SortExpression="CarNo" />
                    <asp:BoundField DataField="InspectorNo" HeaderText="InspectorNo" ReadOnly="True" SortExpression="InspectorNo" />
            ...
            <br />
                 <asp:Button ID="btnReturn" runat="server" Text="Return" OnClick="btnReturn_Click" BackColor="#00CCFF" />        
            </div>
