...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lblHeading" runat="server" Text="Insert Data" Font-Size="18pt" Font-Bold="True" ForeColor="Blue"></asp:Label>
            ...
            <br />
            <asp:Button ID="btnDriver" runat="server" OnClick="btnDriver_Click" Text="Driver" BackColor="#0066CC" />
            <asp:Button ID="btnInspector" runat="server" OnClick="btnInspector_Click" Text="Inspector" BackColor="#0066FF" />
            <asp:Button ID="btnCar" runat="server" Text="Car" OnClick="btnCar_Click" BackColor="#6699FF" />
            <br />
        ...
        <p>
            <asp:Button ID="btnInsertDriver" runat="server" OnClick="btnInsertDriver_Click" Text="Insert" Visible="False" BackColor="#6699FF" />
        </p>
        <p>
        ...
        <p>
            <asp:Button ID="btnInsertInspector" runat="server" OnClick="btnInsertInspector_Click" Text="Insert" Visible="False" BackColor="#6699FF" />
        </p>
        <p>
        ...
        <p>
            <asp:Button ID="btnInsertCar" runat="server" Text="Insert" OnClick="btnInsertCar_Click" Visible="False" BackColor="#6699FF" />
        </p>
        <p>
            <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" Text="Return" BackColor="#99CCFF" />
        </p>
        <p>
            &nbsp;</p>
        <p>
